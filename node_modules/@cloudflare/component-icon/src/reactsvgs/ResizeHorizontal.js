...
const ResizeHorizontal = ({ className, label }) => (
  <svg
    ...
    viewBox="0 0 16 16"
  >
    <path d="M6.3 2.7l-5 5a.4.4 0 0 0 0 .6l4.9 4.9a.4.4 0 0 0 .7-.3V3a.4.4 0 0 0-.6-.3zM9.7 13.2l4.9-4.9a.4.4 0 0 0 0-.6l-4.9-5A.4.4 0 0 0 9 3v9.9a.4.4 0 0 0 .7.3z" />
  </svg>
);
