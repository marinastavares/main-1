...
const Sad = ({ className, label }) => (
  <svg
    ...
    viewBox="0 0 16 16"
  >
    <circle cx="5.397" cy="6.67" r=".948" />
    <circle cx="10.591" cy="6.67" r=".948" />
    <path d="M14.756 5.7a7.143 7.143 0 1 0-.347 5.427 7.065 7.065 0 0 0 .347-5.427zm-1.036 5.1a6.352 6.352 0 1 1 .652-2.8 6.389 6.389 0 0 1-.652 2.8z" />
