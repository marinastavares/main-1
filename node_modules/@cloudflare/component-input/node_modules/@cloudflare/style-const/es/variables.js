...
const namedColors = {
  ...
  tangerine: {
    value: '#FF7900',
    replacement: 'orange[6]'
  },
  pumpkin: {
    value: '#E66B00',
    replacement: 'orange[4]'
  },
  carrot: {
    value: '#f56500',
    replacement: 'orange[5]'
  },
  moonshine: {
    value: '#F7F7F7',
    replacement: 'gray[9]'
  ...
  twilight: {
    value: '#8176B5',
    replacement: 'violet[5]'
  },
  sunset: {
    value: '#BA77B1',
    replacement: 'violet[4]'
  },
  dawn: {
    value: '#F16975',
    replacement: 'red[5]'
...
const themeColors = {
  ...
  colorMuted: {
    value: darken(0.5125, '#fff'),
    replacement: 'colors.gray[4]'
  },
  colorSmoke: {
    value: '#f2f2f2',
    replacement: 'colors.gray[9]'
  },
  colorBlue: {
    value: '#2f7bbf',
    replacement: 'colors.blue[4]'
  },
  colorBlueLight: {
  ...
  colorGrayBorder: {
    value: '#666',
    replacement: 'colors.gray[3]'
  },
  colorGreen: {
    value: '#9bca3e',
    replacement: 'colors.green[6]'
  },
  colorGreenLight: {
  ...
  colorTwitterBlue: {
    value: '#00aced',
    replacement: 'colors.vendor.twitter'
  },
  colorFacebookBlue: {
    value: '#3b5998',
...
Object.keys(namedColors).forEach(color => {
  Object.defineProperty(theme.colors, color, {
    get: function get() {
      const matchingColor = namedColors[color];

      if (showWarnings) {
        console.warn(`Usage of named colors (such as ${color}) is now deprecated. Try using ${matchingColor.replacement} instead.`);
      }
