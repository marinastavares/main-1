 ...
 */
export declare type PropTypes<C> = C extends React.ComponentType<infer P> ? P : never;
/**
 ...
 */
export declare type Arguments<F extends Function> = F extends (...args: infer A) => any ? A : never;
/**
 ...
 */
export declare type ValueOfArray<T extends Array<any> | ReadonlyArray<any>> = T extends Array<infer U> ? U : T extends ReadonlyArray<infer RO> ? RO : never;
/**
 ...
 */
export declare type KeyOfUnion<Union> = keyof UnionToIntersection<Union>;
/**
 ...
 */
export declare type NonReadonly<T extends ReadonlyArray<any>> = T extends ReadonlyArray<infer X> ? X[] : never;
/**
 ...
 */
export declare type Tail<T extends any[]> = ((...args: T) => any) extends (arg: any, ...args: infer TT) => any ? TT : [];
/**
 * Append T to R where R is a tuple
 */
export declare type Prepend<T, R extends any[]> = ((t: T, ...rest: R) => any) extends (...tt: infer TT) => any ? TT : never;
/**
 * Reverses the given tuple type.
 */
export declare type Reverse<Tuple extends any[], Result extends any[] = []> = {
    return: Result;
 ...
 */
export declare type PartialKeys<T, K extends keyof T = keyof T> = Omit<T, K> & {
    [P in K]?: T[P];
};
/**
 ...
 */
export declare type RequiredKeys<T, K extends keyof T = keyof T> = Omit<T, K> & {
    [P in K]-?: T[P];
};
/**
 ...
 */
export declare type ReadonlyKeys<T, K extends keyof T = keyof T> = Omit<T, K> & {
    readonly [P in K]: T[P];
};
/**
...
export declare type PromiseType<P> = P extends Promise<infer T> ? T : never;
/**
