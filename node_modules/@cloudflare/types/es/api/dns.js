...
export const DNSOutgoingZoneTransfers = eg.union([eg.literal('Enabled'), eg.literal('Disabled')]);
export const HostnameRegions = eg.array(eg.object({
  key: eg.string,
  label: eg.string
}));
