...
const SteeringPolicy = eg.union([eg.literal('off'), eg.literal('dynamic_latency'), eg.literal('geo'), eg.literal('random'), eg.literal('gps'), eg.literal('proximity')]).optional;
export const LoadBalancerRuleOverrides = eg.object({
  session_affinity: eg.union([eg.literal('none'), eg.literal('cookie'), eg.literal('ip_cookie')]).optional,
