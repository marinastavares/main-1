...
export const PaymentGateway = eg.union([eg.literal('paypal'), eg.literal('stripe'), eg.literal('')]);
...
export const PaymentMethodType = eg.union([eg.literal('PAYPAL'), eg.literal('CREDIT_CARD')]);
...
export const BillingAccountType = eg.union([eg.literal('partners_ent'), eg.literal('ad_hoc_contract'), eg.literal('employee'), eg.literal('election'), eg.literal('sfcc'), eg.literal('partners_basic'), eg.literal('startup'), eg.literal('intern'), eg.literal('ibm'), eg.literal('pay_go'), eg.literal('cloudflare_ent')]);
...
export const BillableUsageMetric = eg.union([eg.literal('streamMinutesViewed'), eg.literal('rateLimitingRequestsAllowed'), eg.literal('loadBalancingQueries'), eg.literal('argoAcceleratedBytes'), eg.literal('workersRequests'), eg.literal('workersKVReads'), eg.literal('imageResizingRequests'), eg.literal('spectrumBytesTransferred')]);
export const BillableUsageTimeDelta = eg.union([eg.literal('minute'), eg.literal('hour'), eg.literal('day'), eg.literal('week'), eg.literal('month'), eg.literal('quarter'), eg.literal('year')]);
...
export const PlanName = eg.union([eg.literal('CF_BIZ'), eg.literal('CF_BIZ_EMP'), eg.literal('CF_BIZ_FREE'), eg.literal('CF_BIZ_PLUS'), eg.literal('CF_ENT'), eg.literal('CF_FREE'), eg.literal('CF_PRO_20_20'), eg.literal('CF_PRO_20_5'), eg.literal('CF_PRO_FREE')]);
