...
var linkStyles = function linkStyles(_ref) {
  ...
  return {
    ...
    color: disabled ? theme.colors.gray[4] : (0, _styleConst.isDarkMode)() ? theme.colors.blue[3] : theme.colors.blue[4],
    textDecoration: 'none',
    ...
    '&:hover': {
      color: disabled ? theme.colors.gray[4] : theme.colors.orange[(0, _styleConst.isDarkMode)() ? 3 : 6],
      textDecoration: 'none',
      '& svg': {
        fill: 'currentColor'
      }
...
var Link = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(Link, [{
    ...
    value: function render() {
      ...
      var filteredProps = (0, _styleContainer.filterValidElementProps)('a', props);
      return /*#__PURE__*/_react.default.createElement("a", _extends({
        ref: this.ref
      }, filteredProps, {
        "data-testid": this.props.testId
      }), children, expandable && /*#__PURE__*/_react.default.createElement(_componentArrowSwivel.ArrowSwivel, {
        isActive: isActive
      }));
    }
  }]);
